...
subroutine microp_driver_tend(state, ptend, dtime, pbuf)
   ...
   !++ MCB namelist
   use micro_mg_cam, only: MCB_seeding_amt
   !-- MCB namelist
   ...
   case ('MG')
      ...
      call get_MCB_mask(lchnk, ncol, MCB_seeding_mask, MCB_seeding_amt)
      call micro_mg_cam_tend(state, ptend, dtime, pbuf, MCB_seeding_mask)
      !-- MCB revised
