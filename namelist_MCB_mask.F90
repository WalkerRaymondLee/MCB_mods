...
character(len=*), parameter :: mask_file = '/glade/u/home/cchen/MCB/mask_0375_SSP245_full/mask_0375_005-100_SSP245.nc'
real(r8), save :: mask2D(plon, plat, 12, 36)
...
subroutine get_MCB_mask(lchnk, ncol, mask, pct_id)
       use time_manager,       only: get_curr_date
       use cam_history,        only: outfld

       integer, intent(in) :: lchnk
       integer, intent(in) :: ncol
       integer, intent(in) :: pct_id
       ...
       do i=1,ncol
          mask(i) = mask2D(lons(i), lats(i), mon, pct_id)
       end do
