...
!++ MCB
  call mpi_bcast(MCB_seeding_pct, 1, mpi_real8, mstrid, mpicom, ierr)
  if (ierr /= 0) call endrun(sub//": FATAL: mpi_bcast: MCB_seeding_pct")
!-- MCB
...
!++ MCB
     write(iulog,*) 'MCB seeding percentage of ocean area'
     write(iulog,*) '  MCB_seeding_pct = ', MCB_seeding_pct
  end if
...
!++ MCB
   MCB_seeding_pct_ID = 0
   if(MCB_seeding_pct >= 0.5_r8) then
      MCB_seeding_pct_ID = (MCB_seeding_pct-0.5_r8)/0.25_r8+1
   endif
