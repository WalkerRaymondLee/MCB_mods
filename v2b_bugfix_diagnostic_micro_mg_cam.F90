...
!++ MCB, declare MCB_mask as an output variable
   ...
   call addfld ('MCB_mask_MG2',        horiz_only,   'A', 'fraction', 'MCB seeding mask seen in MG2'                            )
!-- MCB
...
!-- MCB revised
   ...
   !++ MCB
   real(r8) :: MCB_seeding_mask_MG2(mgncol)
   real(r8) :: MCB_seeding_mask_full(pcols)
   !++
...
!                 lchnk, ncol )
                 ...
                 lchnk, ncol, MCB_seeding_mask_MG2 )
         MCB_seeding_mask_full = packer%unpack(MCB_seeding_mask_MG2, MCB_seeding_mask)
!-- MCB revised
!-- MCB            
         end select
      end select
...
!        endif
   ...
   !++ MCB
   call outfld('MCB_mask_MG2', MCB_seeding_mask_full, pcols, lchnk)
   !-- MCB
